...
`vid-list-spring` is a simple Spring Boot video catalog application that displays Movie and TV Show data sourced from https://www.themoviedb.org/documentation/api[themoviedb api].
